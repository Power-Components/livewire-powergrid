            ...
            <div class="col-12" style="text-align: right;">
                <label class="col-12 col-sm-8">
                    ...
                    <div class="form-group has-search">
                        ...
                        <input wire:model.debounce.300ms="search" type="text" class="col-12 col-sm-8 form-control livewire_powergrid_input" placeholder="{{ trans('livewire-powergrid::datatable.labels.search_placeholder') }}">
                    </div>
                    @endif
                </label>
            </div>
