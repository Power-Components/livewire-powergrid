...
>
    ...
    <ul
        ...
        x-show="open"
        x-cloak
        class="dropdown-content z-[50] menu p-2 shadow bg-base-100 rounded-box w-max mt-2 flex flex-col gap-2"
    >
        @if (in_array('xlsx', data_get($setUp, 'exportable.type')))
            <li class="p-0 flex-row items-center hover:bg-transparent focus:bg-transparent active:bg-transparent">
                <div
                    class="flex items-center gap-2 p-0 hover:bg-transparent active:bg-transparent focus:bg-transparent">
