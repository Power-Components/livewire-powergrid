    ...
    @if ($queues > 0 && $showExporting)
        @if ($batchExporting && !$batchFinished)
            <div
                ...
                class="w-full my-3 px-4 rounded dark:text-zinc-300 bg-zinc-100 dark:bg-zinc-800 py-3 text-center"
            >
        ...
        @if ($batchFinished)
            <div class="w-full my-3 dark:bg-zinc-800">
                ...
                >
                    <div
                        class="px-4 py-3 rounded-md cursor-pointer bg-zinc-100 shadow dark:bg-zinc-800"
                    ...
                    >
                        <div class="flex justify-between">
                            ...
                            <x-livewire-powergrid::icons.chevron-double-down
                                class="w-5 text-zinc-400 dark:text-zinc-200"
                            />
                        </div>
                    </div>
                    <div
                    ...
                    >
                        @foreach ($exportedFiles as $file)
                            <div class="flex w-full p-2">
                                ...
                                />
                                <a
                                    class="cursor-pointer text-zinc-600 dark:text-zinc-300"
