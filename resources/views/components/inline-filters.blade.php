...
@php
    $trClasses = Arr::toCssClasses([ theme_style($this->theme, 'table.body.tr'),  theme_style($this->theme, 'table.body.trFilters')]);
    $tdClasses = Arr::toCssClasses([ theme_style($this->theme, 'table.body.td'),  theme_style($this->theme, 'table.body.tdFilters')]);
    $trStyles = Arr::toCssClasses([ theme_style($this->theme, 'table.body.tr.1'),  theme_style($this->theme, 'table.body.trFilters.1')]);
    $tdStyles = Arr::toCssClasses([ theme_style($this->theme, 'table.body.td.1'),  theme_style($this->theme, 'table.body.tdFilters.1')]);
@endphp
