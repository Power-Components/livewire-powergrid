    ...
    <div class="flex flex-row mt-2 md:mt-0 w-full flex justify-start sm:justify-center md:justify-end">
        ...
        <div class="relative w-full md:w-4/12 float-end float-right md:w-full lg:w-1/2">
            ...
            <input wire:model.debounce.600ms="search" type="text"
                   ...
                   class="block w-full float-right bg-gray-100 text-gray-700 border border-gray-300 rounded py-2 px-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 pl-10 dark:bg-gray-500 dark:text-gray-200 dark:placeholder-gray-200 dark:border-gray-500"
