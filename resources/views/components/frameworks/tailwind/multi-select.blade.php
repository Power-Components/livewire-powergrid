                ...
                <div
                    ...
                    <div class="flex flex-auto flex-wrap">
                        ...
                        <template x-for="(option, index) in selected" :key="index">
                            <div
                                class="flex justify-center items-center m-1 cursor-pointer inline-flex rounded-full items-center py-0.5 pl-2.5 pr-1 text-sm font-medium bg-blue-100 text-blue-700 dark:bg-blue-400 dark:text-blue-900">
                                <div
                                    ...
                                    <div x-bind:class="option.selected ? 'border-blue-600' : ''"
                                        ...
                                        <div class="w-full items-center flex">
                                            ...
                                            <div class="absolute inset-y-0 right-0 flex items-center pr-2">
                                                <svg class="w-5 h-5 text-blue-500 dark:text-blue-900" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
